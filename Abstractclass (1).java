...
public class Abstractclass {
    ...
    public static void main(String[] args) {
       ...
       boolean userDoesNotWantToQuit = true;
        ...
        Set<Element> list = new Set<Element>();
        ...
        while(userDoesNotWantToQuit){
                ...
                switch (getMenuChoice()) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        displayAllCandidateNames(list);
                        //menuChoice = getMenuChoice();
                        break;
                    case 4:
                        displayAllDonorNames(list);
                        //menuChoice = getMenuChoice();
                        break;
                    case 5:
                        displayParticularCandidate(list);
                        //menuChoice = getMenuChoice();
                        break;
                    case 6:
                        displayParticularDonor(list);
                        //menuChoice = getMenuChoice();
                        break;
                    case 7:
                        removeCandidate(list);
                        //menuChoice = getMenuChoice();
                        break;
                    case 8:
                        removeDonor(list);
    ...
    public static void addCandidate(Set<Element> aSet) {
        Element anElement;
    ...
    public static void addDonor (Set <Element> aSet) {
        Element anElement;
    ...
    public static void displayAllCandidateNames(Set <Element> theElemSet){
    ...
    public static void displayAllDonorNames(Set <Element>theElemSet) {
        System.out.println("Display all the Donor names in the Set");
        Element anElement;
    ...
    public static void displayParticularCandidate (Set <Element>aSet) {
    ...
    public static void displayParticularDonor(Set <Element> aSet) {
    ...
    public static void removeCandidate(Set<Element> aSet) {
        Scanner kb = new Scanner(System.in);
    ...
    //asks user for donor name and removes donor from elementSet class
    public static void removeDonor(Set <Element>aSet) {
        Scanner kb = new Scanner(System.in);
